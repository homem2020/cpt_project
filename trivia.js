...
if (ans===1){
    ...
    if(yy==="C"){
       ...
       sound1.play();
        ...
        score++
         document.getElementById("image_3").style.visibility = "visible";
       ...
       sound2.play();
           document.getElementById("image_4").style.visibility = "visible";
...
document.getElementById("image_2").style.visibility = "hidden";
	...
	document.view.question.value="Congratulations!  You have completed the quiz.  Your score was " + final + "%.  To retry the quiz, press the REDO button";
    document.view.qans.value=""
     document.getElementById("image_3").style.visibility = "hidden";
    document.getElementById("image_4").style.visibility = "hidden";
